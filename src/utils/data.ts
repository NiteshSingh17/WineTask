...
export const WINE_DATA: Array<WineDataType> = WINE_DATA_TEMP.map( w => ({
  "Alcohol": parseFloat(w.Alcohol+''),
  "Malic Acid": parseFloat(w['Malic Acid'] + ''),
  "Ash": parseFloat(w.Ash + ''),
  "Alcalinity of ash": parseFloat(w['Alcalinity of ash'] + ''),
  "Magnesium": parseFloat(w['Magnesium'] + ''),
  "Total phenols": parseFloat(w['Total phenols'] + ''),
  "Flavanoids": parseFloat(w['Flavanoids'] + ''),
  "Nonflavanoid phenols": parseFloat(w['Nonflavanoid phenols'] + ''),
  "Proanthocyanins": parseFloat(w['Proanthocyanins'] + ''),
  "Color intensity": parseFloat(w['Color intensity'] + ''),
  "Hue": parseFloat(w['Hue'] + ''),
  "OD280/OD315 of diluted wines":parseFloat(w['OD280/OD315 of diluted wines'] + ''),
  "Unknown": parseFloat(w['Unknown'] + ''),
}) )